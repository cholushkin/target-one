...
blend_file = "../ArtSources/company-logo.blend"  # Path to your .blend file
export_directory = "../Unity/TargetOne/Assets/Core/Fbx/CompanyLogo"  # Directory to save the FBX files
