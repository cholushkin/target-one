...
objects_to_export = ["ChunkGameLogo"]  # Modify this list as per your needs
blend_file = "../ArtSources/game-logo.blend"  # Path to your .blend file
export_directory = "../Unity/TargetOne/Assets/Core/Fbx/GameLogo"  # Directory to save the FBX files
