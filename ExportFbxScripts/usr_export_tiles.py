...
objects_to_export = ["Tile.Castle.001", "Tile.Castle.002", "Tile.Castle.003", "Tile.Castle.004"]  # Modify this list as per your needs
blend_file = "../ArtSources/tiles.blend"  # Path to your .blend file
export_directory = "../Unity/TargetOne/Assets/Core/Fbx/Tiles"  # Directory to save the FBX files
